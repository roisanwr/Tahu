...
export const content = {
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        quote:
          "Dulu selalu ditolak bank karena tidak punya laporan keuangan formal. Dengan Tahu, profil usaha saya akhirnya bisa dinilai secara adil.",
        name:   "Andi Nugroho",
        role:   "Jasa Logistik",
        city:   "Surabaya",
        initials: "AN",
  ...
  footer: {
    ...
    copyright: "© 2026 Tahu. Hak cipta dilindungi. Terdaftar di bawah pengawasan OJK.",
  },
};
