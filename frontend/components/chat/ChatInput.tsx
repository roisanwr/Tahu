  ...
  return (
    <div style={{ padding: "16px", background: "var(--color-surface)", borderTop: "1px solid var(--color-border)", zIndex: 10, flexShrink: 0 }}>
      ...
      <div style={{ display: "flex", gap: 12, alignItems: "flex-end" }}>
        <div style={{ flex: 1, background: "var(--color-bg)", borderRadius: 20, border: "1px solid var(--color-border)", display: "flex", alignItems: "center", padding: "4px 4px 4px 16px", transition: "border-color 0.2s" }}>
          <input
            type="text"
            value={inputValue}
